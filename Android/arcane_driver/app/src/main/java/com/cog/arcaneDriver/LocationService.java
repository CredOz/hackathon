        ...
        if(Map_Activity.p == 0)
          {
           ...
           // Map_Activity.time.setText("Total Time: " + diff + " minutes");
            ...
            {
                Toast.makeText(LocationService.this, "DISTANCE==>"+new DecimalFormat("#.###").format(distance) + " Km's.", Toast.LENGTH_SHORT).show();
            }

            lStart = lEnd;
            strDistance=new DecimalFormat("#.###").format(distance)+"Km";
