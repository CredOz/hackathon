...
<form id="user_edit" action="<?php echo base_url('administrator/members/changepassword/'.$this->uri->segment(4,0)); ?>" method="post">
<div class="col-md-10 col-sm-8 col-xs-12">
...
<div class="col-md-2 col-sm-4 col-xs-12 text_box_text">
<?php echo ("Confirm Password"); ?><span style="color: red;">*</span>
</div>
<div class="col-md-10 col-sm-8 col-xs-12">
