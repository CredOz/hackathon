...
<style>
	@media only screen and (min-device-width: 300px) and (max-device-width: 1024px) {
		.table {
			margin: 80px 0px 90px 40px !important;
		}
	}
</style>
...
<div class="head-pad1">
	 <h3 class="page-header3"style="font-size: 30px;color: #1ABB9C;font-family: " source_sans_proregular";text-align:="" left;"=""><?php echo 'Promo code'; ?></h3>
	 </div>


<form action="<?php echo base_url('/administrator/coupon/addcoupon'); ?>" id="myform" method="post" style="margin: -100px" >
...
<!-- <tr> 
		...
		<td>
          ...
          <input  name="submit"  class="btn-default" type="submit" value="Submit" ></td>
	  	</tr>  
