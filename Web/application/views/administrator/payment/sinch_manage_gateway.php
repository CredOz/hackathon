...
$(document).ready(function(){
		...
		echo form_open('administrator/payment/sinch_manage_gateway'); ?>
	 
	 <div class="col-md-12 col-sm-8 col-xs-12">
	 <div class="col-md-2 col-sm-4 col-xs-12 text_box_text"style="position: relative;top: 5px;">
	 <?php echo 'Sinch APP Key'; ?><span style="color: red;">*</span></div>
	<div class="col-md-10 col-sm-8 col-xs-12">
	...
	<?php echo 'Sinch Secret key'; ?><span style="color: red;">*</span></div>
