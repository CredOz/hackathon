...
@media only screen and (min-device-width : 300px) and (max-device-width : 1024px)
{
	...
	.res_table td:nth-of-type(2):before { content: "Date & Time" ; }
...
<!--<script src="<?php echo base_url();?>/js/sorttable.js"></script>-->
	<?php  	
		...
		$tmpl = array (
                    'table_open'          => '<table class="table res_table " id="sort_list" border="0" cellpadding="4" cellspacing="0" style="position: relative;left: 12px;">',
		...
		$ridername = GetRiderNameByID($user['rider_id']);
			...
			$this->table->add_row(
                ...
                $paymode,
				$status,
				anchor(base_url('administrator/payment/braintreedetails/'.$user['_id']),('View Details')),
				$tid
				);
	...
	/*
		...
		echo '<div class="col-md-6 col-sm-12 col-xs-12" ><br><br><br><h2 class="page-header-ab" >'.'Transaction Management'.'</h2></div></div></div>';
...
<?php
	...
	//	echo '<br/>';
		...
		<!-- Export txt and csv -->
			<input type="submit" name="export2" class="btn-default1" value="Export as Txt file">			
			<input type="submit" name="export_csv2" class="btn-default1" value="Export as Csv file">
